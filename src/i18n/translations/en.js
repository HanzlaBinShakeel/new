export default {
  ...
  hero: {
    titleLine1: 'Transformational Leadership',
    titleLine2: 'For Peace, Justice, and Global Impact',
...
He is recipient of the Faith and Tolerance Award from the Arab American Anti-Discrimination Committee and is committed to peace and justice in Palestine and to strengthening the identity of Palestinians in the Diaspora.`,
  ...
  articleCategories: {
    ...
    reflectionsDesc: 'Personal and seasonal reflections on faith, Palestine, and peace.',
    perspectives: 'Perspectives',
    perspectivesDesc: 'Essays on spirituality, politics, and moral courage in the Holy Land.',
    politicalAnalysis: 'Political Analysis',
    politicalAnalysisDesc: 'Analysis of policy, media narratives, and justice in Palestine and beyond.',
    nationBuilding: 'Nation-Building',
    nationBuildingDesc: 'Building identity, solidarity, and a shared future for Palestinians.',
    leadership: 'Leadership',
    leadershipDesc: 'Leadership, resistance, and advocacy for peace and justice.',
